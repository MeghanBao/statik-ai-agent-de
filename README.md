...
[!WARNING] Alle Berechnungen und KI-generierten Texte dienen ausschließlich der Orientierung. Sie ersetzen keine qualifizierte statische Berechnung durch einen staatlich geprüften Tragwerksplaner.
...
Öffne anschließend http://localhost:8501 im Browser.

📖 Verwendung
1. Trägerberechnung
Wähle Träger
Trägertyp auswählen (Einfeld, Krag, Durchlauf)
Länge und Last eingeben
Material und Profil wählen
Berechnung starten
2. Rahmenberechnung
Wähle Rahmen
System wählen (eingeschossig / zweigeschossig)
Abmessungen eingeben und Berechnung durchführen
3. Plattenberechnung
Wähle Platte
Plattentyp und Abmessungen eingeben
Bewehrung wird automatisch berechnet
4. KI-Assistent
